...
def parse_args():
    ...
    parser.add_argument('-i', '--csvPath', type=Path, help='path to csv file', default='results/_instance_ratio_real.csv')
    parser.add_argument('-t', '--targetvar', type=str, help='csv variable to plot', default='instance_ratio')
    parser.add_argument('-n', '--plotName', type=Path, help='path to store the plot', default='results/_instance_ratio_real.png')
