...
def parse_args():
    ...
    parser.add_argument('-i', '--csvPath', type=Path, help='path to csv file', default='results/_cluster_equivalency_artificial.csv')
    parser.add_argument('-t', '--targetvar', type=str, help='csv variable to plot', default='normalized_mutual_info')
    parser.add_argument('-n', '--plotName', type=Path, help='path to store the plot', default='results/_normalized_mutual_info.png')
