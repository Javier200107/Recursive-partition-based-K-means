...
def compute(n_clusters, n_dims, n_samples, k_means_kwargs, computationIdx):
    ...
    ref_clf = KMeans(n_clusters=n_clusters, n_init=1, init=clf.centroids, algorithm='lloyd')
...
if __name__ == '__main__':
    ...
    results.to_csv(OUT_FOLDER / '_cluster_equivalency_artificial.csv', sep=',', index=False)
